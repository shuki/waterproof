...
<p>
	<table class="data">
		...
		<tr>
			<td class="header">
				קריאה תחילת תקופה מונה 1 (משותף) 
			</td>
			<td class="detail">
				{$row->last_amount1}
			</td>
		...
		<tr>
			<td class="header">
				קריאה תחילת תקופה מונה 2 (משותף) 
			</td>
			<td class="detail">
				{$row->last_amount2}
			</td>
		...
		<tr>
			...
			<td class="detail">
				{$row->total_usage_relative_round}
			</td>
		</tr>
		<tr class="separator">
			<td class="separator">
		...
		<tr>
			<td class="header">
				הנחה {$row->shared_discount_rate_round}%
			</td>
			<td class="detail">
				{$row->discount} ₪
			</td>
